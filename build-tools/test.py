"""
Run tests for the mmif-python package.

This script is equivalent to::

    pip install -e ".[test]"
    pytype mmif
    python -m pytest --cov=mmif --cov-report=xml -m "not slow"
"""
import argparse
import subprocess
import sys
...
def main():
    parser = argparse.ArgumentParser(
        description="Run tests for the mmif-python package."
    )
    parser.add_argument(
        "--skip-install",
        action="store_true",
